...
<head>
  ...
  <style>
    ...
    input {padding:10px;margin:5px 0;width:400px;}
    button {padding:12px;background:#0f0;color:black;}
    pre {background:#111;padding:15px;}
  </style>
</head>
<body>
  <h1>VLESS WS TLS Config Generator</h1>
  Domain: <input id="d" value="your-project.vercel.app"><br>
  UUID: <input id="u" value="de04add9-5c68-8bab-950c-08cd5320df18"><br>
  Path: <input id="p" value="/vless"><br><br>
